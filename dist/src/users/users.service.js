...
let UsersService = class UsersService {
    constructor(usersRepository, surveyRepository) {
    ...
    async createUser(createUserDto) {
        ...
        if (duplicatedUser) {
            throw new common_1.ConflictException('Duplicated fcmToken');
        }
        try {
            const { survey, ...user } = await this.usersRepository.save(createUserDto);
    ...
    async updateUserToken(fcmToken, userId) {
